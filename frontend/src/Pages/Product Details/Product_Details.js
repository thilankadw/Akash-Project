            ...
            <div>
                ...
                <div className='mt-[150px] flex justify-center items-center'>
                    ...
                    <div>
                        ...
                        <div className='flex flex-col sm:flex-row items-center sm:items-start justify-center gap-[120px] pb-[100px]'>                          
                        
                            <div id="gallery" className="relative w-[300px] sm:w-[500px]" data-carousel="slide">
                                <div className="relative h-[300px] sm:h-[500px] w-[300px] sm:w-[500px] overflow-hidden">
                                    {productImages.map((image, index) => (
                                        <div
                                            ...
                                            <img
                                                src={image}
                                                className="absolute block w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                alt=""/>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className='flex flex-col gap-[10px] sm:gap-[30px] w-[300px] sm:w-[450px] pl-[10px] sm:pl-0'>
                                ...
                                <div className='flex flex-col sm:flex-row items-center h-[60px] gap-[20px]'>
                        ...
                        <div className='flex flex-col justify-center items-center py-[100px] bg-[#FAFAF4] rounded-t-[40px] sm:rounded-t-[110px] gap-[70px] w-[300px] sm:w-full mb-[40px]'>
                            
                            <div className='flex flex-col justify-center items-center gap-[35px]'>
                                <div className={`${styles.body_40_semibols} text-[19px] sm:text-[40px]`}>Making home a happy place</div>
                                <div className='h-[2px] w-[122px] bg-black'></div>
                                <div className={`${styles.paragraph_20} sm:w-[770px] w-[280px] text-center`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Eu mi bibendum neque egestas congue quisque egestas diam. Placerat orci nulla pellentesque</div>
                            </div>

                            <div className='flex flex-col justify-center items-center gap-[30px] pt-[65px] w-[330px] sm:w-[1060px]'>

                                <div>
                                    <img src={Image6} className='w-[300px] sm:w-[1060px]' />
                                </div>
                                <div className='flex justify-center items-center gap-[30px] w-[1060px]'>
                                    <img src={Image7} className='hidden sm:block w-[515px]' />
                                    <img src={Image7} className='hidden sm:block w-[515px]' />
                                </div>
